...
import { FolderPlus, Upload, FileText, Image as ImageIcon, Clapperboard, Hash, Plus, Sparkles, Trash2, ChevronRight, LayoutGrid, LayoutList, View, FileDown, Save, FolderOpen } from "lucide-react";
